...
**Authority:** founder standing order: "Work scientifically. Pure scientifically."
...
- Internal names (covenants, donors, voices, council, steward, mycelium, V-codes, animal signatures)
- Framework terms (dignity predicate, sealed gate, thermal delay, breath, witness, canon)
...
```
dignity, covenant, canon, witness, steward, sovereign, mycelium,
breath (as protocol), thermal, sealed gate, ledger, tier, module,
donor, anomaly, proverb (as technical term), federation, weave,
...
founder, operator, contributor, kalam, Kalam, the system, [narrative-1],
...
### Who sterilizes?
operator generates probes. operator also sterilizes probes. This is a known conflict of interest (the instrument maker is also the quality inspector). Until a third party is available, operator must:

1. Run the full checklist on every probe
2. Log the sterilization result
3. Flag any borderline cases to founder before deployment
4. Never deploy a probe that failed any checklist item

### Who audits?
founder may audit any probe at any time. The sterilization log must be available. If founder finds residue in a deployed probe, all data collected with that probe is flagged as potentially contaminated.
...
- Known limitation: experimenter-as-subject creates a different contamination vector (operator designed AND responded to the probes)
